...
class NonProjectBOMDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = NonProjectBOMDetail
        fields = '__all__'

class PrincipalBOMDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = PrincipalBOMDetail
        fields = '__all__'
